...
const EditProfile: React.FC = () => {
    ...
    <div className="space-y-1.5 lg:short:space-y-0.5">
      ...
      {isTextArea ? (
        <textarea
          ...
          rows={4}
          className="w-full bg-white dark:bg-surface-dark border-none rounded-2xl py-4 px-5 text-sm leading-relaxed shadow-sm focus:ring-2 focus:ring-primary/50 dark:text-white placeholder:text-stone-300 resize-none lg:short:py-2 lg:short:px-3 lg:short:text-xs lg:short:leading-snug"
        />
      ) : (
        <input
          type={type}
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-10 lg:short:pb-4 animate-in fade-in duration-300">
      {/* Header */}
      ...
      <main className="p-6 lg:short:p-3">
        {/* Avatar Section */}
        <div className="flex flex-col items-center mb-10 lg:short:mb-2">
          <div className="relative group">
            <div className="size-28 lg:short:size-18 rounded-full overflow-hidden border-4 lg:short:border-2 border-white dark:border-surface-dark shadow-xl">
              <img
          ...
          <button className="mt-4 lg:short:mt-1.5 text-xs lg:short:text-[9px] font-black text-primary uppercase tracking-widest">
            Fotoğrafı Değiştir
          </button>
        </div>

        {/* Form Section */}
        <div className="space-y-6 lg:short:space-y-2.5">
          <InputField
            label="Ad Soyad"
            value={formData.name}
        ...
        {/* Save Button */}
        <div className="mt-12 lg:short:mt-3">
          <button
            onClick={handleSave}
            className="w-full h-14 lg:short:h-10 bg-primary text-white rounded-2xl font-black text-xs lg:short:text-[10px] uppercase tracking-[0.2em] lg:short:tracking-widest shadow-lg shadow-primary/30 active:scale-95 transition-all"
          >
