...
const WordDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-32 lg:pb-20">
      ...
      <main className="max-w-[1600px] mx-auto lg:px-12 lg:py-8">
        <div className="lg:flex lg:gap-12 items-start">
          ...
          <div className="w-full lg:w-[38%] xl:w-[32%] lg:sticky lg:top-24 shrink-0">
            <div className="relative h-[220px] lg:h-[400px] overflow-hidden bg-stone-100 dark:bg-stone-900 rounded-b-[1.5rem] lg:rounded-[3rem] shadow-lg lg:shadow-2xl">
              <img 
                src={word.imageUrl} 
                alt={word.term} 
          ...
          <div className="flex-1 px-5 -mt-4 lg:mt-0 relative z-10 lg:px-0">
            <div className="bg-white dark:bg-surface-dark rounded-[2rem] lg:rounded-none lg:bg-transparent lg:dark:bg-transparent p-5 md:p-8 lg:p-0 shadow-xl lg:shadow-none border lg:border-none border-black/5">
              ...
              <div className="flex flex-col gap-1 mb-6 lg:mb-6">
                <h2 className="text-3xl lg:text-7xl font-black tracking-tighter text-stone-900 dark:text-white leading-none">
                  {word.term}
                </h2>
                <p className="text-sm lg:text-2xl font-bold text-primary/60 italic">
                  {word.pronunciation}
                </p>
              </div>
              ...
              <div className="space-y-6 lg:space-y-6">
                <div className="animate-in fade-in duration-1000">
                  <div className="flex items-center gap-2 mb-3 lg:mb-4">
                    ...
                    <p className="text-[10px] lg:text-xl text-primary font-black uppercase tracking-widest">
                      {word.turkishEquivalent}
                    </p>
                  </div>

                  <p className="text-base lg:text-2xl text-text-main dark:text-gray-200 leading-relaxed font-bold">
                    {word.definition}
                  </p>
                </div>

                {/* Example Card - Padding adjusted to save vertical space */}
                <div className="relative overflow-hidden rounded-[1.5rem] lg:rounded-[2.5rem] bg-stone-50 dark:bg-white/5 p-5 lg:p-6 border border-black/[0.03] lg:bg-white lg:shadow-lg group">
                  <div className="flex gap-3 lg:gap-6 relative z-10">
                    <span className="material-symbols-outlined text-primary text-3xl lg:text-6xl opacity-30 shrink-0">format_quote</span>
                    <div className="space-y-1.5 lg:space-y-3">
                      <p className="text-lg lg:text-3xl font-black italic leading-tight text-stone-800 dark:text-white">
                        "{word.exampleSentence}"
                      </p>
                      <p className="text-[10px] lg:text-base text-text-muted font-bold opacity-60">
            ...
            <div className="mt-8 lg:mt-6">
              <div className="flex items-center justify-between mb-4 px-1">
                <div className="flex items-center gap-2.5">
                  <h3 className="text-lg lg:text-3xl font-black tracking-tighter text-text-main dark:text-white">Tartışmalar</h3>
